---
name: documentation
description: Guidelines and instructions for generating C# extension methods usage documentation for the Maestria.TypeProviders.
---

# Maestria.TypeProviders Documentation Skill
